...
public class UsuarioServiceImpl implements UsuarioService {
	...
	// convierte en UsuarioDTO / PartidaDTO los datos que llegan de la BBDD (Usuario / Partida)
		private UsuarioDTO mapEntitytoDTOUsuario(Usuario usuario) {
			...
			dto.setPartidas(usuario.getPartidas(dto));
	...
	// convierte en  Usuario / Partida los datos que llegan de la vista (UsuarioDTO) para
		// poderlos volcar a las BBDD
